...
"""Verify that starting blackravend with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start blackravend with -h for help text")
        ...
        self.log.info("Start blackravend with -version for version information")
