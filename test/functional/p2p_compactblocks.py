...
# TestP2PConn: A peer we use to send messages to blackravend, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    # This test actually causes blackravend to (reasonably!) disconnect us, so do this last.
    ...
    # Test that blackravend requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for blackravend to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # blackravend will not send blocktxn responses for blocks whose height is
