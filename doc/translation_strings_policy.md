...
This document provides guidelines for internationalization of the BlackRaven software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `blackraven_en.ts` remains unchanged.
