...
Format: ```mngovernance prepare proposal-name url payment-count block-start blackraven-address monthly-payment-neoxa```
...
Format: ```mngovernance submit proposal-name url payment-count block-start blackraven-address monthly-payment-neoxa fee-tx```
...
The following RPC commands are supported:
 ...
 - mngovernance "command"... ( "passphrase" )
  ...
  - vote               - Vote on a proposal by single smartnode (using neoxa.conf setup)
