...
Acquire the source in the usual way:
    ...
    git clone https://github.com/BlackRavenChain/BlackRaven
    cd neoxa
...
example /usr/src/neoxa, AND not under /mnt/d/. If this is not the case the dependency autoconf scripts will fail.
