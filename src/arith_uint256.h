...
#ifndef BLACKRAVEN_ARITH_UINT256_H
#define BLACKRAVEN_ARITH_UINT256_H
...
public:
     ...
     *
     * BlackRaven only uses this "compact" format for encoding difficulty
...
#endif // BLACKRAVEN_ARITH_UINT256_H
