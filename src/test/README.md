...
To run the blackraven-qt tests manually, launch `src/qt/test/test_blackraven-qt`

To add more blackraven-qt tests, add them to the `src/qt/test/` directory and
...
unit testing framework, and since BlackRaven already uses boost, it makes
