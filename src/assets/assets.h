...
#ifndef BLACKRAVENCOIN_ASSET_PROTOCOL_H
#define BLACKRAVENCOIN_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_BLACKRAVEN_ASSET BLKRQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_BLACKRAVEN_ASSET BLKRO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_BLACKRAVEN_ASSET BLKRR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_BLACKRAVEN_ASSET BLKRT
...
#endif //BLACKRAVENCOIN_ASSET_PROTOCOL_H
