 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called BlackRaven (https://www.blackraven.network/),
...
bool AppInit(int argc, char* argv[])
{
    ...
    if (gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") ||  gArgs.IsArgSet("-help") || gArgs.IsArgSet("-version"))
    {
        ...
        {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  blackravend [options]                     " + strprintf(_("Start %s Daemon"), _(PACKAGE_NAME)) + "\n";
    ...
    try
    {
        ...
        {
#if HAVE_DECL_DAEMON
            fprintf(stdout, "BlackRaven server starting\n");
...
int main(int argc, char* argv[])
{
    ...
    // Connect blackravend signal handlers
    noui_connect();
