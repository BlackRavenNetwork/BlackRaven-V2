...
public:
   ...
   /**
    ...
    void AvailableCoinsAll(std::vector<COutput>& vCoins, std::map<std::string, std::vector<COutput> >& mapAssetCoins,
                            bool fGetBLKR = true, bool fOnlyAssets = false,
    ...
    /**
     * Helper function that calls AvailableCoinsAll, used to receive all coins, Assets and BLKR
     */
    ...
    /// Get collateral BLKR output and keys which can be used for the Smartnode
