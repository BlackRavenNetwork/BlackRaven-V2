...
CAmount AmountFromValue(const UniValue& value, bool p_isBLKR)
{
...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    return "BlackRaven server stopping";
}
...
{
    return "> blackraven-cli " + methodname + " " + args + "\n";
}
