...
public:
    CMainParams() {
        ...
        consensus.nSmartnodePaymentsIncreaseBlock = INT_MAX;
        consensus.nSmartnodePaymentsIncreasePeriod = INT_MAX;
        ...
        consensus.DIP0003Height = INT_MAX; // ProTx / deterministic smartnodes disabled
        ...
        consensus.nPowTargetTimespan = 2016 * 60; // BlackRaven: 1 day
        consensus.nPowTargetSpacing = 1 * 60; // BlackRaven: 1 minutes
        ...
        consensus.smartnodePaymentFixedBlock = INT_MAX;
        ...
        consensus.llmqTypeChainLocks = Consensus::LLMQ_NONE;
        consensus.llmqTypeInstantSend = Consensus::LLMQ_NONE;
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.nPowTargetTimespan = 2016 * 60; // BlackRaven: 1 day
        consensus.nPowTargetSpacing = 60; // BlackRaven: 1 minutes
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        consensus.nPowDGWHeight = 1;
		consensus.DGWBlocksAvg = 60;
        ...
        // Testnet BlackRaven script addresses start with '8' or '9'
        ...
        // Testnet BlackRaven BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet BlackRaven BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet BlackRaven BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 10227;
...
public:
    CDevNetParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 2; // DIP0003 activated immediately on devnet
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // BlackRaven: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // BlackRaven: 2.5 minutes
...
public:
    CRegTestParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 500;
        consensus.powLimit = uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 1
        consensus.nPowTargetTimespan = 24 * 60 * 60; // BlackRaven: 1 day
        consensus.nPowTargetSpacing = 2 * 60; // BlackRaven: 2.5 minutes
        ...
        // Regtest BlackRaven addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest BlackRaven script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest BlackRaven BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest BlackRaven BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest BlackRaven BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
