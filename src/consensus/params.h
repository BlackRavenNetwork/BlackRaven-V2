...
// See https://github.com/blackraven/dips/blob/master/dip-0006.md for more details
struct LLMQParams {
    LLMQType type;
...
struct Params {
    ...
    /** When false, no smartnode collateral, payments, or ProTx registration on this network. */
    bool fSmartnodesEnabled{true};
