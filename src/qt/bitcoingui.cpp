...
void BitcoinGUI::createActions()
{
    ...
    TransferAssetsAction->setStatusTip(tr("Transfer assets to BLKR addresses"));
    ...
    aboutAction = new QAction(QIcon(":/icons/blackraven"), tr("&About %1").arg(tr(PACKAGE_NAME)), this);
    aboutAction->setStatusTip(tr("Show information about BlackRaven"));
    ...
    toggleHideAction = new QAction(QIcon(":/icons/blackraven"), tr("&Show / Hide"), this);
...
void BitcoinGUI::createToolBars()
{
    ...
    if(walletFrame)
    {
        ...
        // Add BlackRaven logo on the right side
        QWidget* spacer = new QWidget();
        spacer->setSizePolicy(QSizePolicy::Expanding, QSizePolicy::Expanding);
        toolbar->addWidget(spacer);

        QLabel *logoLabel = new QLabel();
        QPixmap logoPixmap(":/images/blackraven_logo_toolbar");
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BlackRaven network", "", count));
    } else {
...
{
    QString strTitle = tr("BlackRaven"); // default title
...
void BitcoinGUI::checkAssets()
{
    ...
    if(AreAssetsDeployed()) {
        ...
        TransferAssetsAction->setToolTip(tr("Transfer assets to BLKR addresses"));
