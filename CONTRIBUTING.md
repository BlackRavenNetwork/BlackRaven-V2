Contributing to BlackRaven
============================

The BlackRaven project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to blackraven-qt
...
[Translation Process](https://github.com/BlackRavenNetwork/BlackRaven-V2/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the BlackRaven project (and related
projects such as libsecp256k1), and is not to be confused with overall BlackRaven
Network Protocol consensus changes.

Whether a pull request is merged into BlackRaven rests with the project merge
...
Patches that change BlackRaven consensus rules are considerably more involved than
...
Where a patch set proposes to change the BlackRaven consensus, it must have been
...
The review process is normally fairly responsive on the BlackRaven repository, however
...
The project leader is the release manager for each BlackRaven release.
