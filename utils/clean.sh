...
rm -f src/config/blackraven-config.h
...
rm -rf test_bitcoin.coverage/ blackraven-gtest.coverage/ total.coverage/
...
clean_dep . src/config/blackraven-config.h.in
